    ...
    return (
        <form className="mt-10">
            ...
            <div className="flex items-center justify-end mt-8">
                <input onClick={e => createAd(e)} type="submit" value="Přidat stálou nabídku" className="text-white bg-black px-8 py-2 cursor-pointer rounded hover:bg-indigo-700 duration-150" />
            </div>
        </form>
    )
}
